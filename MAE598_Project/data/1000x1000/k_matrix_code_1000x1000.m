...
tic()   
    nx = 1000;              % # of elements along  X- direction.
    ny = 1000;              % # of elements along  Y- direction. 
...
%     rank_of_k=rank(K)
    K_forceboundary_elements1000x1000 = K;
    f_forceboundary_elements1000x1000 = f;
    x0_elements1000x1000 = zeros(length(K),1);
    save('K_forceboundary_elements1000x1000.mat', 'K_forceboundary_elements1000x1000')
    save('f_forceboundary_elements1000x1000.mat', 'f_forceboundary_elements1000x1000')
    save('x0_elements1000x1000.mat', 'x0_elements1000x1000')
  toc()
