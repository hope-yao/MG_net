function [] = k_matrix_code()    
    ny = 99;              % # of elements along  X- direction. 65
    nx = 99;              % # of elements along  Y- direction. 67
    lx= 0.495;              % length in x direction
    ly= 0.495;              % length in y direction
        D = 16 * eye(2);    % W/m-K
    ...
    K_Forceboundary_nodes10x10 = K;
    f_forceboundary_nodes10x10 = f;
    x0_nodes10x10 = zeros(length(K),1);
    save('K_Forceboundary_nodes10x10.mat', 'K_Forceboundary_nodes10x10')
    save('f_forceboundary_nodes10x10.mat', 'f_forceboundary_nodes10x10')
    save('x0_nodes10x10.mat', 'x0_nodes10x10')
end
