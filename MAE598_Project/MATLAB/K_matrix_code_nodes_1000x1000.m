function [] = k_matrix_code()    
    ny = 999;              % # of elements along  X- direction. 65
    nx = 999;              % # of elements along  Y- direction. 67
    lx= 4.995;              % length in x direction
    ly= 4.995;              % length in y direction
        D = 16 * eye(2);    % W/m-K
    ...
    K_Forceboundary_nodes1000x1000 = K;
    f_forceboundary_nodes1000x1000 = f;
    x0_nodes1000x1000 = zeros(length(K),1);
    save('K_Forceboundary_nodes1000x1000.mat', 'K_Forceboundary_nodes1000x1000')
    save('f_forceboundary_nodes1000x1000.mat', 'f_forceboundary_nodes1000x1000')
    save('x0_nodes1000x1000.mat', 'x0_nodes1000x1000')
end
